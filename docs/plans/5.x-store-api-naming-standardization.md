...
**Depends on:** `5.x-store-api-bridges.md` (same pattern: rename API surface now, models/DB later)
...
- All changes are **breaking** in the Store API — no backward compatibility, new names only (same approach as `5.x-store-api-bridges.md`)
...
### 16. Additional Order model aliases (from 5.x-store-api-bridges)
...
- `5.x-store-api-bridges.md` — prior art for this exact pattern
